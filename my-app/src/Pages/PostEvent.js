...
import { MDBIcon, MDBCol, MDBCardBody, MDBCard } from "mdbreact";
const tableIcons = {
...
function PostEvent() {
  const [state, setState] = React.useState({
    columns: [
      ...
      { title: "Event Details", field: "EventDetails" },
    ],
    data: [
      { Sr: "1", EventName: "Labour Day", EventDetails: "its Holiday " },
      {
        Sr: "2",
        EventName: "Defense Day",
        EventDetails: "its Holiday!! ",
      },
    ],
  });
